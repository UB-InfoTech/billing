...
function Order2() {
    ...
    //     const sorted = [...orders]; // replace with actual data variable
    ...
    // const sortedData = useMemo(() => {
    //     const sorted = [...orders]; // replace with your actual array
    //     const { key, direction } = sortConfig;
                        ...
                        <table className="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colSpan={7}></td>
                                    <td colSpan="1" className="fw-bold">₹{sortedData.reduce((sum, order) => sum + parseFloat(order.finalRevenue), 0)}</td>
                                    <td colSpan="1" className="fw-bold">₹{sortedData.reduce((sum, order) => sum + parseFloat(order.paidAmount), 0)}</td>
                                    <td colSpan="1" className="fw-bold">₹{sortedData.reduce((sum, order) => sum + parseFloat(order.dueAmount), 0)}</td>
                                    <td colSpan={1}></td>
                                                    ...
                                                    <div className="card-body p-4 bg-light">
                                                        ...
                                                        {subOrders.map((order, index) => (
                                                            <div key={index} className="row g-3 mb-2">
                                                                ...
                                                                {/* <div className="col-md-1">
                                                                    {(order.qtyUnit === "MTR")?  (order.MTR * order.unitPrice) : (order.MTR * order.unitPrice) }
                                                                </div> */}
                                                                <div className="col-md-1 d-flex align-items-center">
                                                                    {subOrders.length > 1 && (
