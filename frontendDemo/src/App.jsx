...
import BulkPayment2 from './pages/BulkPayment2.jsx';
// import CreditNoteOld from './pages/CreditNoteOld.jsx';
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        {/* <Route path="/credit-noteOld" element={
            <CreditNoteOld />
        } /> */}
        ...
        <Route path="/bulk-payment2" element={
          <ProtectedRoute>
            <BulkPayment2 />
          </ProtectedRoute>
        } />
