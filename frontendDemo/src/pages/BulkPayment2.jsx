...
//     const amount = customSplits[orderId] || 0;
//     if (amount < 0) {
...
//     errors._total = 'Total allocated amount must equal payment amount';
//   }
...
//     <td>₹{order.dueAmount.toLocaleString()}</td>
//     {showCustomAmount && (
//       <td>
//         <input
//           type="number"
...
//   paymentAmount 
// }) => {
//   const isAmountMismatch = Math.abs(parseFloat(paymentAmount || 0) - totalAllocated) > 0.01;
...
//                 <td>₹{allocation.dueAmount.toLocaleString()}</td>
//                 <td>₹{allocation.allocated.toLocaleString()}</td>
//               </tr>
//             ))}
//           </tbody>
//         </table>
...
//         <strong>Total Payment Due: ₹{totalDue.toLocaleString()}</strong>
...
//           Payment amount does not match total allocated. Please adjust!
//         </div>
//       )}
//     </div>
//   );
...
// export default function BulkPayment2() {
//   // State management
...
//     selectedOrdersData.reduce((sum, o) => sum + o.dueAmount, 0),
//     [selectedOrdersData]
//   );
...
//         allocated: Math.round((o.dueAmount / totalDue) * parseFloat(form.amount)),
...
//       }));
//     }
//   }, [form.amount, form.splitType, selectedOrdersData, totalDue, customSplits]);

//   const totalAllocated = useMemo(() => 
//     allocatedPreview.reduce((sum, a) => sum + a.allocated, 0),
//     [allocatedPreview]
//   );
